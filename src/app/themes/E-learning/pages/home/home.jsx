      ...
      <section className="home page">
        <div className="hero">
          ...
          <div className="elevator-pitch">
            <p>E-learning Platform with Video Streaming is an international learning platform. You can study anytime, anywhere and network with your classmates around the world! You can also earn money by uploading your courses...</p>
            <p>
